            ...
            ((function (A) {
                var e = (function (A) {
                                ...
                                return new e(function (t, B) {
                                    !(function t(n, i, B, E) {
                                        ...
                                        if ("throw" !== r.type) {
                                            var o = r.arg,
                                                I = o.value;
                                            return I && "object" == typeof I && g.call(I, "__await")
                    ...
                    function y(A, t) {
                        ...
                        return i
                            ? i.done
                                ? ((t[A.resultName] = i.value), (t.next = A.nextLoc), "return" !== t.method && ((t.method = "next"), (t.arg = e)), (t.delegate = null), c)
                                : i
                    ...
                    return (
                        (u.prototype = p.constructor = h),
                        (h.constructor = u),
                        (u.displayName = r(h, E, "GeneratorFunction")),
                        ...
                        (J.prototype = {
                            ...
                            delegateYield: function (A, t, g) {
                                return (this.delegate = { iterator: R(A), resultName: t, nextLoc: g }), "next" === this.method && (this.arg = e), c;
                            },
                        }),
                        A
                    );
                ...
                B(A, [
                    ...
                    },
                    {
                        ...
                        value: function (A) {
                            if (0 !== A.length) {
                                ...
                                var n = new CustomEvent("fileUploadWithPreview:imagesAdded", { detail: { files: A, uploadId: this.uploadId, cachedFileArray: this.cachedFileArray, addedFilesCount: e } });
                                        ...
                                        e.input.multiple &&
                                            ...
                                            A.type.match("image/png") || A.type.match("image/jpeg") || A.type.match("image/gif")
                                                ? e.options.showDeleteButtonOnImages
                                                    ? (e.imagePreview.innerHTML += '\n                            <div\n                              data-id='+ coun +'  class="custom-file-container__image-multi-preview"\n                                data-upload-token="'
                                                          .concat(A.token, '"\n                                style="background-image: url(\'')
                                                          .concat(
                                                              t.result,
                                                              '\'); "\n                            >\n                                <span class="custom-file-container__image-multi-preview__single-image-clear">\n                                    <span\n                                      data-id=12  class="custom-file-container__image-multi-preview__single-image-clear__icon"\n                                        data-upload-token="'
                                                          )
                                                          .concat(A.token, '"\n                                    >&times;</span>\n                                </span>\n                            </div>\n                        '))
                                                    : (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=11  class="custom-file-container__image-multi-preview"\n                                data-upload-token="'
                                                          .concat(A.token, '"\n                                style="background-image: url(\'')
                                                          .concat(t.result, "'); \"\n                            ></div>\n                        "))
                                                : A.type.match("application/pdf")
                                                ? e.options.showDeleteButtonOnImages
                                                    ? (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=13  class="custom-file-container__image-multi-preview"\n                                data-upload-token="'
                                                          .concat(A.token, '"\n                                style="background-image: url(\'')
                                                          .concat(
                                                              e.successPdfImage,
                                                              '\'); "\n                            >\n                                <span class="custom-file-container__image-multi-preview__single-image-clear">\n                                    <span\n                                      data-id=12  class="custom-file-container__image-multi-preview__single-image-clear__icon"\n                                        data-upload-token="'
                                                          ...
                                                          .concat(A.token, '"\n                                    >&times;</span>\n                                </span>\n                            </div>\n                        '))
                                                    : (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=14  class="custom-file-container__image-multi-preview"\n                                data-upload-token="'
                                                          .concat(A.token, '"\n                                style="background-image: url(\'')
                                                          .concat(e.successPdfImage, "'); \"\n                            ></div>\n                        "))
                                                : A.type.match("video/*")
                                                ? e.options.showDeleteButtonOnImages
                                                    ? (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=15  class="custom-file-container__image-multi-preview"\n                                style="background-image: url(\''
                                                          ...
                                                          .concat(A.token, '"\n                                    >&times;</span>\n                                </span>\n                            </div>\n                        '))
                                                    : (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=16  class="custom-file-container__image-multi-preview"\n                                style="background-image: url(\''
                                                          .concat(e.successVideoImage, '\'); "\n                                data-upload-token="')
                                                          .concat(A.token, '"\n                            ></div>\n                        '))
                                                : e.options.showDeleteButtonOnImages
                                                ? (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=17  class="custom-file-container__image-multi-preview"\n                                style="background-image: url(\''
                                                      ...
                                                      .concat(A.token, '"\n                                    >&times;</span>\n                                </span>\n                            </div>\n                        '))
                                                : (e.imagePreview.innerHTML += '\n                            <div\n                              data-id=18  class="custom-file-container__image-multi-preview"\n                                style="background-image: url(\''
                                                      .concat(e.successFileAltImage, '\'); "\n                                data-upload-token="')
                                                      .concat(A.token, '"\n                            ></div>\n                        ')));
                              coun++;  });
                        },
                    ...
                    },
                    {
                        ...
                        value: function (A) {
                            ...
                            var e = new CustomEvent("fileUploadWithPreview:imageDeleted", { detail: { index: A, uploadId: this.uploadId, cachedFileArray: this.cachedFileArray, currentFileCount: this.currentFileCount } });
